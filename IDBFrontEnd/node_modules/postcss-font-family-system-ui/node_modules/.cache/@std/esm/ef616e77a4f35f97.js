"main";/*{"e":{"default":1},"m":{"postcss":["default"],"postcss-value-parser":["default"]},"s":[],"w":null}*/let postcss;_a4f‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_a4f‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);
...
_a4f‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
