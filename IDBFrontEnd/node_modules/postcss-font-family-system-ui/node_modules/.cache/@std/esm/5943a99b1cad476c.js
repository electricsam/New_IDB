"main";/*{"e":{"default":1},"m":{"postcss":["default"],"postcss-value-parser":["default"]},"s":[],"w":null}*/let postcss;_1ca‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_1ca‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);
...
_1ca‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
