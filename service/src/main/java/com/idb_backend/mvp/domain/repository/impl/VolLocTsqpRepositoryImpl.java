...
public class VolLocTsqpRepositoryImpl extends QuerydslRepositorySupport implements VolLocTsqpCustomRepository {
  ...
  /**
   * Returns Iterable<VolLocTsqpProjection> generated by query to VolLocTsqp, in which the where clause is formed by
   * passing the given predicate.
   *
   * @param predicate
   * @return Iterable<VolLocTsqpProjection>
   */
  @Override
  ...
  /**
   * Returns List<VolLocTsqpProjection> generated by query to VolcanoEvent and VolLocTsqp, in which the where clause is
   * formed by passing given eventId.  Purpose is to find specific VolcanoLoc related to given VolcanoEvent id.
   *
   * @param eventId
   * @return List<VolLocTsqpProjection>
   */
  @Override
