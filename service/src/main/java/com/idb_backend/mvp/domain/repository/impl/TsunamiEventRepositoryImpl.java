...
public class TsunamiEventRepositoryImpl extends QuerydslRepositorySupport implements TsunamiEventCustomRepository{
  ...
  /**
   * Returns Iterable object comprised of TsunamiEventView objects, generated by query on junction table between
   * Earthquakes and Tsunamis, where Tsunamis with given earthquakeId are returned.
   *
   * @param earthquakeId
  ...
  /**
   * Returns Iterable object comprised of TsunamiEventView objects, generated by query on junction table between
   * References and Tsunamis, where Tsunamis with given refId are returned.
   *
   * @param refId
   * @return Iterable<TsunamiEventView>
   */
  ...
  /**
   * Returns Iterable object comprised of TsunamiEventView objects, generated by query on junction table between
   * Volcanoes and Tsunamis, where Tsunamis with given volId are returned.
   *
   * @param volId
   * @return Iterable<TsunamiEventView>
   */
  ...
  /**
   * Returns Iterable object comprised of TsunamiEventView objects, generated by query on junction table between
   * Runups and Tsunamis, where Tsunamis with given refId are returned.
   *
   * @param runupId
   * @return Iterable<TsunamiEventView>
   */
