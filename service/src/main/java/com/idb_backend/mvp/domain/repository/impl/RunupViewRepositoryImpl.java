...
public class RunupViewRepositoryImpl extends QuerydslRepositorySupport implements RunupViewCustomRepository {
  ...
  /**
   * Returns List RunupProjection Objects, generated by query on both the TsunamiRunupView and TsunamiEventView tables,
   * in which the where clause is passed the given Predicate.
   *
   * @param predicate
   * @return List<RunupProjection>
   */
  @Override
  ...
  /**
   * Returns List of RunupProjection objects, generated by query on the junction table between Runups and Tsunamis,
   * where all Runups related to a given Tsunami are found
   *
   * @param tsunamiId
   * @return List<RunupProjection>
   */
  ...
  /**
   * * Returns List of RunupProjection objects, generated by query on the junction table between Runups and References,
   * where all Runups related to a given References are found
   *
   * @param refId
   * @return List<RunupProjection>
   */
  ...
  /**
   * Returns List of RunupMoreInfoProjection objects, generated by query on the RunupView Table, where Runup of given
   * id is returned.
   *
   * @param runupId
   * @return List<RunupMoreInfoProjection>
   */
