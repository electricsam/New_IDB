...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case 'POST_VOLCANO_LOC_REQUESTED': {
      return state.merge(state, { postingVolcanoLoc: true, postedVolcanoLoc: false, postVolcanoLocFail: false });
    }
    ...
    case 'POST_VOLCANO_LOC_REJECTED': {
      return state.merge(state, { postingVolcanoLoc: false, postVolcanoLocFail: true, error: action.payload });
    }
    ...
    case 'PATCH_VOLCANO_LOC_REQUESTED': {
      return state.merge(state, { patchingVolcanoLoc: true, patchedVolcanoLoc: false, patchVolcanoLocFail: false, });
    }
    case 'PATCH_VOLCANO_LOC_FULFILLED': {
      return state.merge(state, { patchingVolcanoLoc: false, patchedVolcanoLoc: true });
    }
    case 'PATCH_VOLCANO_LOC_REJECTED': {
      return state.merge(state, { patchingVolcanoLoc: false, patchVolcanoLocFail: true, error: action.payload });
    }
    ...
    case 'RESET_VOLCANO_EVENT_SEARCH': {
      return state.merge(state, {search: {}, name: null, location: null, commentType: null});
    }
    case 'RESET_VOLCANO_LOC_SEARCH': {
      return state.merge(state, {locSearch: {}, locName: null,});
    }
    default:
      return state;
    }
